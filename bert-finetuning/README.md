...
Tokenize the reviews using the BERT tokenizer
Pad and truncate sequences to a maximum length of 128
Convert the dataset into PyTorch tensors
Rename the label column to labels for compatibility with the Hugging Face model
